...
const s = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontWeight: "600", color: COLORS.muted, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: SPACE.md },
  ...
  taxRowText: { flex: 1, fontSize: 14, fontWeight: "600", color: COLORS.text },
  ...
  cancelBtnText: { color: COLORS.red, fontSize: 14, fontWeight: "600" },
  ...
  disconnectBtnText: { color: COLORS.red, fontSize: 12, fontWeight: "600" },
});
