...
const s = StyleSheet.create({
  ...
  resultSymbolText: { fontSize: 10, fontWeight: "600", color: COLORS.primary },
  resultSymbol: { fontSize: 14, fontWeight: "600", color: COLORS.text },
  ...
  quoteSymbol: { fontSize: 18, fontWeight: "600", color: COLORS.text },
  quoteDescription: { fontSize: 12, color: COLORS.muted, fontWeight: "500", marginTop: 2, maxWidth: 180 },
  quotePrice: { fontSize: 20, fontWeight: "600", color: COLORS.text },
