...
import { CARD_SHADOW, GLASS_BORDER, RADIUS, SPACE } from "./designSystem";
...
export function makeStyles(colors: ColorTokens) {
  return StyleSheet.create({
    ...
    bigBottomBtnText: { color: "#FFFFFF", fontWeight: "600", fontSize: 16 },
    ...
    // ─────────────────────────────────────────────
    bigTitle: {
      fontSize: 20, fontWeight: "600", marginTop: 10,
      color: colors.text, marginBottom: 10,
    },
    muted: { color: colors.muted, fontWeight: "600" },

    pageSectionTitle: { fontSize: 15, fontWeight: "600", color: colors.text },
    headerTitle: { fontSize: 15, fontWeight: "600", color: colors.text },
    flowHeaderTitle: { fontWeight: "600", color: colors.text, fontSize: 15, flex: 1, textAlign: "center" },
    ...
    getGiftText: { marginLeft: 6, fontWeight: "600", color: colors.accentDark },
    ...
    hideBalanceText: { color: colors.muted, fontWeight: "600" },
    ...
    accountLabel: { fontWeight: "600", color: colors.textSecondary },
    accountLabelWhite: { fontWeight: "600", color: "#FFFFFF", fontSize: 18, margin: 4 },
    accountAmount: { marginTop: 16, fontSize: 26, fontWeight: "600", color: colors.text },
    accountAmountWhite: { marginTop: 16, fontSize: 26, fontWeight: "600", color: "#FFFFFF" },
    cardCornerImage: {
    ...
    recentBank: { marginTop: 2, color: colors.muted, fontWeight: "600", fontSize: 11 },
    ...
    sheetTitle: { textAlign: "center", fontWeight: "600", fontSize: 15, marginBottom: 10, marginTop: 12 },
    ...
    sheetRowAmt: { fontWeight: "600", color: colors.text },
    sheetText: {
    ...
    amountInput: { flex: 1, fontSize: 34, fontWeight: "600", color: colors.text, paddingVertical: 6 },
    currencyPill: {
      flexDirection: "row", alignItems: "center",
    ...
    groupDate: { fontWeight: "600", color: colors.text, fontSize: 13 },
    ...
    txAmt: { fontWeight: "600", color: colors.text },
    ...
    walletTitle: { marginTop: 8, fontWeight: "600", color: colors.textSecondary },
    walletAmount: { marginTop: 10, fontSize: 36, fontWeight: "600", color: colors.text },
    ...
    methodTitle: { fontWeight: "600", fontSize: 16, marginBottom: 3, color: colors.text },
    ...
    iconBtnText: { fontWeight: "600", color: colors.text, fontSize: 14 },
    ...
    newRecipientText: { fontWeight: "600", fontSize: 15, color: colors.text },
    blockTitle: { marginTop: 18, fontWeight: "600", color: colors.text, fontSize: 15 },
    ...
    toggleText: { marginLeft: 12, fontWeight: "600", color: colors.muted },
    ...
    confirmTitle: { marginTop: 18, fontWeight: "600", fontSize: 18, color: colors.text },
    confirmCard: {
      width: "100%", backgroundColor: colors.card,
      borderRadius: 18, padding: 16, marginTop: 12, alignItems: "center",
      ...GLASS_BORDER,
    },
    confirmName: { fontWeight: "600", fontSize: 16, color: colors.text },
    ...
    reviewSmall: { textAlign: "center", marginTop: 14, color: colors.muted, fontWeight: "600" },
    reviewBig: { textAlign: "center", marginTop: 8, fontSize: 34, fontWeight: "600", color: colors.text },
    ...
    reviewSection: { marginTop: 14, fontWeight: "600", color: colors.text },
    reviewCard: {
    ...
    reviewVal: { fontWeight: "600", color: colors.text },
    ...
    warnTitle: { textAlign: "center", marginTop: 14, fontSize: 26, fontWeight: "600", color: colors.text },
    warnCard: {
      marginTop: 14, backgroundColor: colors.card,
      borderRadius: 18, borderWidth: 1, borderColor: colors.borderLight, padding: 16,
    },
    warnStop: { fontWeight: "600", marginBottom: 8, color: colors.text },
    warnRow: { flexDirection: "row", gap: 10, marginTop: 10 },
    warnX: { color: colors.red, fontWeight: "600", marginTop: 2 },
    ...
    pinTitle: { marginTop: 14, fontSize: 26, fontWeight: "600", color: colors.text },
    ...
    forgotPin: { textAlign: "center", marginTop: 24, color: colors.primary, fontWeight: "600" },
    pinError: {
    ...
    backIcon: { fontSize: 22, fontWeight: "600", color: colors.primary },
    backArrow: { fontSize: 22, fontWeight: "600", color: colors.primary },
    ...
    dialCodeText: { marginRight: 8, fontWeight: "600", color: colors.text },
    ...
    checkEmailTitle: { marginTop: 18, fontSize: 28, fontWeight: "600", textAlign: "center", color: colors.text },
    checkEmailSub: { marginTop: 10, fontSize: 15, textAlign: "center", color: colors.muted },
    checkEmailEmail: { marginTop: 8, fontSize: 16, fontWeight: "600", textAlign: "center", color: colors.text },
    changeEmailLink: { marginTop: 8, fontSize: 15, fontWeight: "600", textAlign: "center", color: colors.primary },
    ...
    stepNumberText: { fontWeight: "600", color: "#FFFFFF", fontSize: 14 },
    stepContent: { flex: 1 },
    ...
    label: { color: colors.muted, fontSize: 14, fontWeight: "600", marginBottom: 8 },
    ...
    addAccountText: { fontSize: 15, fontWeight: "600", color: colors.primary },
    ...
    fxTitle: { fontSize: 16, fontWeight: "600", color: colors.text },
    fxSubtitle: { marginTop: 4, fontSize: 12, fontWeight: "500", color: colors.muted },
    fxSeeAll: { fontSize: 13, fontWeight: "600", color: colors.primary },
    ...
    fxPair: { fontSize: 14, fontWeight: "600", color: colors.text, margin: 25 },
    ...
    notifHeaderTitle: { flex: 1, textAlign: "center", fontSize: 18, fontWeight: "600", color: colors.text, marginRight: 44 },
    notifHeaderAction: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, backgroundColor: colors.primaryLight },
    notifHeaderActionText: { color: colors.primary, fontWeight: "600", fontSize: 12 },
    ...
    notifSectionTitle: { paddingHorizontal: 16, fontSize: 12, fontWeight: "600", color: colors.muted, marginBottom: 8, textTransform: "uppercase", letterSpacing: 0.5 },
    ...
    notifTitle: { fontSize: 14, fontWeight: "600", color: colors.text, flex: 1, paddingRight: 10 },
    ...
    notifEmptyTitle: { marginTop: 12, fontSize: 18, fontWeight: "600", color: colors.text },
    ...
    resultTitle: { fontSize: 22, fontWeight: "600", color: colors.text, textAlign: "center", marginTop: 2 },
    ...
    resultPrimaryBtnText: { color: "#FFFFFF", fontWeight: "600", fontSize: 16 },
    resultSecondaryBtn: { marginTop: 14, alignItems: "center", justifyContent: "center", paddingVertical: 10 },
    resultSecondaryText: { fontWeight: "600", fontSize: 14 },
    ...
    midMarketTitle: { fontSize: 14, fontWeight: "600", color: colors.text },
    midMarketDescription: { fontSize: 12, color: colors.muted, marginTop: 6, lineHeight: 18 },
    midMarketStrong: { fontWeight: "600", color: colors.text },
    ...
    chatQuickText: { fontSize: 12.5, fontWeight: "600", color: colors.text },
    ...
    walletTxGroupTitle: { marginTop: 14, marginBottom: 8, fontSize: 12, fontWeight: "600", color: colors.text, textTransform: "uppercase", letterSpacing: 0.4 },
    ...
    walletTxIconText: { fontSize: 14, fontWeight: "600", color: colors.primary },
    walletTxMid: { flex: 1 },
    walletTxName: { fontSize: 13, fontWeight: "600", color: colors.text },
    ...
    walletTxAmt: { fontSize: 13, fontWeight: "600", color: colors.text },
    ...
    dropdownTitle: { fontWeight: "600", fontSize: 18, marginBottom: 10, color: colors.text },
    ...
    headerCenterTitle: { position: "absolute", left: 0, right: 0, textAlign: "center", fontSize: 16, fontWeight: "600", color: colors.text },
    ...
    sentLabel: { color: colors.green, fontWeight: "600", fontSize: 12, textTransform: "lowercase", marginBottom: 8 },
    bigAmount: { fontSize: 28, fontWeight: "600", color: colors.text },
    ...
    rowLabel: { color: colors.muted, fontWeight: "600", fontSize: 12 },
    ...
    downloadText: { color: colors.primary, fontWeight: "600", fontSize: 12 },
    ...
    updateTitle: { fontWeight: "600", color: colors.text, fontSize: 13 },
    ...
    amount: { fontSize: 30, fontWeight: "600" as const, marginBottom: 16, color: colors.text },
    ...
    statusText: { fontSize: 14, fontWeight: "600" as const, textTransform: "capitalize" as const },

    section: { marginHorizontal: 16, marginTop: 20, backgroundColor: colors.card, borderRadius: 16, padding: 16, ...GLASS_BORDER },
    sectionTitle: { fontSize: 13, fontWeight: "600" as const, color: colors.muted, textTransform: "uppercase" as const, letterSpacing: 0.6, marginBottom: 12 },
    detailLabel: { fontSize: 14, color: colors.muted, fontWeight: "500" as const },
    detailValue: { fontSize: 14, color: colors.text, fontWeight: "600" as const, textAlign: "right" as const, flex: 1, marginLeft: 16 },
    ...
    conversionAmount: { fontSize: 16, color: colors.text, fontWeight: "600" as const },
    ...
    helpButtonText: { color: colors.text, fontWeight: "600" as const, fontSize: 14 },
    bottomArea: { marginTop: 16 },

    // Recipient select screen
    recipientScreen: { width: "100%" },
    recipientHeaderTitle: { fontSize: 18, fontWeight: "600", color: colors.text, textAlign: "center", flex: 1 },
    ...
    helpCircleText: { fontWeight: "600", color: colors.primary },
    ...
    bankRowArrow: { fontSize: 22, fontWeight: "600", color: colors.primary },
    ...
    recipientListTitle: { fontSize: 20, fontWeight: "600", color: colors.text },
    ...
    recipientListHelpText: { fontWeight: "600", color: colors.primary },
    ...
    recipientListNewText: { marginLeft: 12, fontSize: 16, fontWeight: "600", color: colors.text },
    recipientListSectionTitle: { marginTop: 18, marginBottom: 10, fontSize: 15, fontWeight: "600", color: colors.text },
    ...
    recipientListAvatarText: { color: "#FFFFFF", fontWeight: "600" },
    recipientListRowInfo: { marginLeft: 12, flex: 1 },
    recipientListRowName: { fontSize: 16, fontWeight: "600", color: colors.text },
    ...
    refHowTitle: { fontSize: 15, fontWeight: "600", color: colors.text },
    ...
    refStepBadgeText: { color: "#FFFFFF", fontSize: 12, fontWeight: "600" },
    ...
    recentEmptyTitle: { fontSize: 14, fontWeight: "600", color: colors.text, textAlign: "center" },
    ...
    recentEmptyBtnText: { fontSize: 12, fontWeight: "600", color: colors.primary },
    ...
    globalTitle: { fontSize: 26, fontWeight: "600", color: colors.text, marginBottom: 12 },
    ...
    verifySmallTitle: { color: colors.primary, fontWeight: "600", fontSize: 13, marginBottom: 6 },
    verifyBigTitle: { color: colors.text, fontWeight: "600", fontSize: 22, marginBottom: 10 },
    ...
    verifyProgressText: { color: colors.text, fontWeight: "600", fontSize: 13 },
