          ...
          {benchmarkChangePct != null && (
            <View style={s.benchmarkRow}>
              <AppText style={s.benchmarkText}>
                S&amp;P 500 over this period: <AppText style={{ fontWeight: "600", color: benchmarkChangePct >= 0 ? COLORS.green : COLORS.red }}>
...
const s = StyleSheet.create({
  ...
  connectBtnCompactText: { fontSize: 11, fontWeight: "600", color: COLORS.primary },
  totalAmount: { fontSize: 38, fontWeight: "600", color: COLORS.text, marginTop: 4, letterSpacing: -1 },
  ...
  quickActionLabel: { fontSize: 11, fontWeight: "600", color: COLORS.text },
  ...
  chartLabel: { fontSize: 12, fontWeight: "600", color: COLORS.muted, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  rangePillText: { fontSize: 12, fontWeight: "600", color: COLORS.muted },
  ...
  dividendLabel: { fontSize: 12, fontWeight: "600", color: COLORS.muted, textTransform: "uppercase", letterSpacing: 0.4 },
  dividendAmount: { fontSize: 16, fontWeight: "600", color: COLORS.text, marginTop: 2 },
  dividendSub: { fontSize: 12, color: COLORS.muted, fontWeight: "600", marginTop: 1 },
  taxLink: { fontSize: 12, fontWeight: "600", color: COLORS.primary, marginBottom: 2 },
  ...
  balanceBig: { fontSize: 20, fontWeight: "600", color: COLORS.text },
  ...
  tradeSheetTitle: { fontSize: 16, fontWeight: "600", color: COLORS.text, marginBottom: SPACE.lg },
  ...
  tradeSheetRowTitle: { fontSize: 14, fontWeight: "600", color: COLORS.text },
