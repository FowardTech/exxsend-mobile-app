...
const s = StyleSheet.create({
  ...
  sectionHeader: { fontSize: 12, fontWeight: "600", color: COLORS.muted, textTransform: "uppercase", letterSpacing: 0.5, marginTop: SPACE.lg, marginBottom: SPACE.sm },
  ...
  amountBase: { fontSize: 13, fontWeight: "600", color: COLORS.text },
