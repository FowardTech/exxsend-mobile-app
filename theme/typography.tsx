...
export const T = {
  ...
  smBold: { fontSize: 12, fontWeight: "600" as const, color: COLORS.text },
  ...
  bodyBold: { fontSize: 13, fontWeight: "600" as const, color: COLORS.text },

  // UI Labels
  label: { fontSize: 14, fontWeight: "600" as const, color: COLORS.text },
  labelBold: { fontSize: 14, fontWeight: "600" as const, color: COLORS.text },

  // Titles
  title: { fontSize: 16, fontWeight: "600" as const, color: COLORS.text },
  titleLg: { fontSize: 18, fontWeight: "600" as const, color: COLORS.text },
  titleXl: { fontSize: 22, fontWeight: "600" as const, color: COLORS.text },

  // Numerics
  balance: { fontSize: 28, fontWeight: "600" as const, color: COLORS.text, letterSpacing: -0.5 },
  balanceLg: { fontSize: 34, fontWeight: "600" as const, color: COLORS.text, letterSpacing: -1 },
